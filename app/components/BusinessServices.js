...
export default function BusinessServices() {
  const [serviceImages, setServiceImages] = useState({ businessServices: [] });
  ...
  const dummyServices = {
    businessServices: [
      ...
      },
      {
        ...
        image: "https://d18jakcjgoan9.cloudfront.net/s/img/home/accounting.jpg!d=v1NTZ1", // Simulating missing image
        badge: "Available online",
      },
      {
        id: 3,
        title: "Marketing & SEO",
        image: "https://d18jakcjgoan9.cloudfront.net/s/img/home/social-media-marketing.jpg!d=v1NTZ1",
      },
    ],
  };
      ...
      <div className="container">
        ...
        <div>
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h3 className="mb-0">Business Services</h3>
            <a href="#" className="text-decoration-none">View All</a>
          </div>

          <div className="row row-cols-1 row-cols-md-3 g-4 mt-3">
            {serviceImages?.businessServices?.map((service, index) => (
